    ...
    <section className="py-12 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Featured Taxi Companies</h2>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Top-rated companies with excellent service</p>
          </div>
          <Link
            to="/search"
