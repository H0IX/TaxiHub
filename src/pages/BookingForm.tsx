        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
                  ...
                  {index < totalSteps - 1 && (
                    <div
                      className={`flex-1 h-0.5 mx-2 ${
                        index + 1 < currentStep ? 'bg-primary-600' : 'bg-gray-300 dark:bg-gray-700'
                      }`}
                    ></div>
                  )}
                </React.Fragment>
            ...
            <div className="flex justify-between mt-2">
              <span className="text-sm font-medium text-gray-900 dark:text-white">Ride Details</span>
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="label text-gray-700 dark:text-gray-300">Vehicle Type</label>
                      <select className="input bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300">
                    ...
                    <div className="md:col-span-2">
                      <label className="label text-gray-700 dark:text-gray-300">Additional Notes</label>
                      <textarea
                        className="input bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"
                        rows={3}
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg mb-6">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Ride Summary</h3>
                  ...
                  <div className="bg-accent-50 dark:bg-accent-900 border border-accent-200 dark:border-accent-700 rounded-lg p-4 flex items-start">
                    <AlertCircle className="h-5 w-5 text-accent-500 dark:text-accent-400 mt-0.5 mr-3 flex-shrink-0" />
                    <p className="text-sm text-accent-700 dark:text-accent-300">
                      You won't be charged until your ride is confirmed. Cancellations made at least
                      1 hour before pickup are free.
                    </p>
                  </div>
                  ...
                  <div className="pt-6 flex justify-between">
                    ...
                    <Button variant="primary">Complete Booking</Button>
                  </div>
                </div>
              )}
            </div>
